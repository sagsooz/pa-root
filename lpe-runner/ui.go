...
func banner() {
	fmt.Print(colW)
	fmt.Println("==============================================================================")
	fmt.Printf("  LPE-Runner v%s  -  Crash-Resilient Localroot Orchestrator\n", version)
	fmt.Println("  Auto-detect | Isolate | Timeout | Stop-on-root | English console")
	fmt.Println("  Authoritative offensive-security testing tool. Use only on systems you own")
	fmt.Println("  or are explicitly authorized to test. Unauthorized use is illegal.")
	fmt.Println("==============================================================================")
	fmt.Print(colZ)
	fmt.Println()
}
